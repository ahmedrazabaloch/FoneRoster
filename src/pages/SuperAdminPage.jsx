...
import { Shield, Upload, Save, Loader, Image, Trash2 } from 'lucide-react';
...
export const SuperAdminPage = () => {
    ...
    const handleSave = async () => {
        setSaving(true);
        try {
            await authorityService.save(
                { authorityName, signatureUrl },
                user?.uid || 'unknown'
            );
            ...
            <div className="bg-white border-4 border-black shadow-brutal-lg p-8">
                ...
                <div className="border-2 border-black p-6 bg-gray-50">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-gray-400 mt-1">
                                JPEG, PNG, WebP · Max 2MB · Transparent PNG recommended
                            </p>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className={`mt-6 w-full flex items-center justify-center gap-2 px-4 py-3 font-black text-sm uppercase tracking-wider border-2 border-black shadow-brutal transition-all ${saving
