...
export const HotlinePanel = ({ currentOperator, shiftName, onDayShift }) => (
    <div className="bg-white border-4 border-black shadow-brutal-xl p-6 md:p-8 flex flex-col h-fit">
        <LiveClock />
        ...
        <div className="mb-6">
            ...
            <div className="inline-block bg-yellow-300 px-4 py-1 border-2 border-black shadow-brutal-sm -rotate-1">
                <span className="block text-xl font-black text-red-600 font-mono tracking-tighter">
                    0313-1234567
                </span>
            </div>
        </div>
        <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="font-black text-sm text-gray-500 uppercase tracking-wider">
                Current Hotline Operator
            </span>
        </div>
        <h2 className="text-4xl md:text-5xl font-black text-gray-900 uppercase leading-none mb-4 break-words">
        ...
        <div className="grid grid-cols-2 gap-4 mt-auto">
            <a
                ...
                className="flex items-center justify-center bg-green-600 text-white border-2 border-black py-3 font-black uppercase shadow-brutal hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-brutal-active transition-all"
            >
                <Phone size={18} className="mr-2" /> Call
            </a>
            <a
                href={formatWhatsAppUrl(currentOperator?.whatsapp)}
                className="flex items-center justify-center bg-gray-900 text-white border-2 border-black py-3 font-black uppercase shadow-brutal hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-brutal-active transition-all"
            >
