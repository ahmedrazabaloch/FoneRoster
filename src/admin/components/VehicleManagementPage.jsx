/**
 * VehicleManagementPage.jsx — Vehicle Management Standalone
 * 
 * Wrapper around VehicleManagement that shows it expanded by default.
 * Used in the Admin Panel's "Vehicles" section.
 */
        ...
        <div className="bg-white border-2 border-black shadow-brutal md:shadow-brutal-lg">
            <div className="p-3 md:p-5 border-b-2 border-black bg-gray-50">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <Truck size={18} />
                        <h3 className="font-black text-base md:text-xl uppercase">Vehicle Fleet</h3>
                    </div>
            ...
            <div className="p-3 md:p-5">
                ...
                {activeVehicles.length > 0 ? (
                    ...
                    <div className="mt-4 p-6 text-center border-2 border-dashed border-gray-300">
                        <p className="text-gray-400 font-bold uppercase text-sm">No vehicles added yet</p>
                    </div>
                )}
            </div>
        </div>
