/**
 * RosterManager.jsx — Admin Roster Control Panel
 *
 * Provides admin editing tools including:
 *   - Field Teams configuration
 *   - Hotline Staff management
 *   - Team Directory (employee management)
 *   - Export tools
 *   - Audit Logs viewer
 *
 * Module visibility is controlled by useAdminPermissions hook.
 */
...
export const RosterManager = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-3 md:px-4 py-4 md:py-8">
            ...
            {activeView === 'directory' && perms.teamDirectory && <TeamDirectory />}
            {activeView === 'exports' && perms.exports && <ExportsPanel />}
            {activeView === 'audit' && perms.auditLogs && <AuditLogs />}
        </div>
    );
};
