/**
 * HotlinePanel.jsx — Hotline Operator Display Panel
 *
 * Displays the current hotline operator with contact options.
 * Part of the Status Panel (left column) in the dashboard.
 */
