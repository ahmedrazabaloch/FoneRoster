/**
 * usePublicDashboardData.js — Sanitized data hook for the public dashboard.
 *
 * PURPOSE:
    ...
    const activeTeams = useMemo(() => {
        ...
        return shiftTeams.map(team => {
            ...
            return {
                ...
                route: team.route || '',
                status, // 'active' | 'warning' | 'unassigned'
                driver: sanitizePerson(driver),
                supervisor: sanitizePerson(supervisor),
                helper: sanitizePerson(helper),
            };
        });
